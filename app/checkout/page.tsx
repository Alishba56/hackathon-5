    ...
    <div>
      <div className="relative w-full h-64 md:h-96">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          ...
          <p className="text-gray-600 text-center text-sm md:text-2xl"><Link href="/">Home</Link> <span>&gt;</span> checkOut</p>
        </div>
      </div>

      <div className="flex flex-col lg:flex-row justify-between p-4 mx-4 mt-20 lg:mx-24">
        ...
        <div className="w-full lg:w-1/2 mt-10 p-4">
          <h2 className="text-2xl font-bold flex justify-between mb-4">Product <span>Subtotal</span></h2>
          <div className="">
